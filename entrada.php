...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container d-flex h-100 align-items-center">
            <div class="mx-auto text-center">
                <h1 class="mx-auto my-0 text-uppercase">Entradas</h1>
                <br><br>
    ...
    <section class="projects-section bg-light" id="projects">
        ...
        $q = 'SELECT p.nome, t.tipo, p.descricao, p.img FROM pratos p inner join tipo t on p.tipo=t.id where t.id = 1';
                ...
                ?>
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <div class="card h-100">
                            ...
                            <a href="#"><img class="card-img-top" src="Images/<?php echo $dados['img'] ?>" alt=""></a>
                            <div class="card-body">
                                <h4 class="card-title">
